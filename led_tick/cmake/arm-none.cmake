...
set(TOOLCHAIN_INC_DIR "${TOOLCHAIN_PATH}/lib/${TOOLCHAIN_PREFIX}/include")
set(TOOLCHAIN_LIB_DIR "${TOOLCHAIN_PATH}/lib/${TOOLCHAIN_PREFIX}/lib")
...
# build options
set(LINKER_SCRIPT "${PROJECT_SOURCE_DIR}/STM32F303K8Tx_FLASH.ld")

set(OBJECT_GEN_FLAGS "-mthumb -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 \
                    -ffunction-sections -fdata-sections \
                    -Wall -Wextra \
                    -DSTM32F303x8 -DUSE_HAL_DRIVER")
...
set(CMAKE_EXE_LINKER_FLAGS "-lc -lm -lnosys -Wl,--gc-sections --specs=nano.specs --specs=nosys.specs -mthumb -mabi=aapcs -Wl,-Map=${CMAKE_PROJECT_NAME}.map -T ${LINKER_SCRIPT}" CACHE INTERNAL "Linker options")
